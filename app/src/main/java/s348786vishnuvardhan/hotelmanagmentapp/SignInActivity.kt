...
fun SignInScreen() {
    ...
    Column(
        ...
        Image(
            modifier = Modifier
                .size(150.dp),
            painter = painterResource(id = R.drawable.ic_hotel_management),
            contentDescription = "Hotel Management"
        )
        ...
        Image(
            painter = painterResource(id = R.drawable.wave_up),
                                            ...
                                            if (snapshot.exists()) {
                                                ...
                                                chefData?.let {
                                                    ...
                                                    if (guestBookingPassword == it.password) {
                                                        ...
                                                        HotelAccountData.markLoginStatus(context!!, true)
                                                        HotelAccountData.saveEmail(
                                                            context,
                                                            email = guestBookingMail
                                                        )
                                                        HotelAccountData.saveName(context, it.name)

                                                        HotelAccountData.saveRole(context,it.role)
